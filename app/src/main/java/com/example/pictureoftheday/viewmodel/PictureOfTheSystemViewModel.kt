...
class PictureOfTheSystemViewModel (
        ...
        when (selectionDate) {
            1 -> {
                ...
                pictureOfTheNasaRetrofitImpl.getRetrofit()
                    .getSolarFlare(BuildConfig.NASA_API_KEY,dateKey)
                    .enqueue(callback)
            }
            2 -> {
                val calendar = Calendar.getInstance()
    ...
    private val callback = object : Callback<List<PictureOfTheSystemResponseDate>> {
        override fun onResponse(
            call: Call<List<PictureOfTheSystemResponseDate>>,
            response: Response<List<PictureOfTheSystemResponseDate>>
        ) {
        ...
        override fun onFailure(call: Call<List<PictureOfTheSystemResponseDate>>, t: Throwable) {
